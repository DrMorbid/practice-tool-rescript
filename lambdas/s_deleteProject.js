...
const handlerWrapperArgs = { functionName: 'practice-tool-rescript-dev-deleteProject', timeout: 6 };

try {
  const userHandler = require('./src/project/Project_Lambda_Delete.res.js');
