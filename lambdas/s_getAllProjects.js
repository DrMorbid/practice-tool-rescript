...
const handlerWrapperArgs = { functionName: 'practice-tool-rescript-dev-getAllProjects', timeout: 6 };

try {
  const userHandler = require('./src/project/Project_Lambda_GetAll.res.js');
