...
const handlerWrapperArgs = { functionName: 'practice-tool-rescript-dev-savePracticeSession', timeout: 6 };

try {
  const userHandler = require('./src/session/Session_Lambda_Save.res.js');
