...
const handlerWrapperArgs = { functionName: 'practice-tool-rescript-dev-getPracticeSession', timeout: 6 };

try {
  const userHandler = require('./src/session/Session_Lambda_Get.res.js');
